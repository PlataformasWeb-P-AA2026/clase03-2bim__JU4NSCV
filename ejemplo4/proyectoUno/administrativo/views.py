...
def index(request):
    ...
    # en el template
    informacion_template = {'estudiantes': estudiantes, 'numero_estudiantes': len(estudiantes), 'paises': paises, 'numero_paises':len(paises)}
...
def crear_pais(request):
    ...
    if request.method=='POST':
        formulario = PaipsForm(request.POST)
